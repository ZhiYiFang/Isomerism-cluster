...
public class GuardCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(GuardCliTestCommand.class);
    protected final GuardCliCommands service;

    public GuardCliTestCommand(final GuardCliCommands service) {
